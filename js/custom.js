$(document).ready(function () {
    ...
    if (time.length) {
        ...
        time.countdown({
            ...
            render: function (data) {
                $(this.el).html(
                    '<div class="cd-row"><div><h1 class="that">' +
                        this.leadingZeros(data.days, 2) +
                        '</h1><p>Days</p></div><div><h1 class="this">' +
                        this.leadingZeros(data.hours, 2) +
                        '</h1><p>Hrs</p></div></div><div class="cd-row"><div><h1 class="that">' +
                        this.leadingZeros(data.min, 2) +
                        '</h1><p>Min</p></div><div><h1 class="this">' +
    ...
    function initMap(map) {
        ...
        var points = [
            ...
            ['<div class="wrapper"><h4>Kounter Agency</h4><h5>Opening Hours</h5><p>Mo – Fr: 08:30 – 20:00</p></div>', 40.6681, -73.9448],
        ];
        // marker
